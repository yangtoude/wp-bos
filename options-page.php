<div class="wrap">
    ...
    <form name="form1" method="post"
          action="<?php echo wp_nonce_url('./options-general.php?page=' . plugin_basename(dirname(__FILE__)) . '/cloud-img-storage.php'); ?>">
        <table class="form-table">
            <tbody>
            <tr valign="top">
                <th scope="row"><label for="bucket">Bucket设置</label></th>
                <td>
                    <input name="bucket" type="text" id="bucket" value="<?php echo $bucket; ?>"
            ...
            <tr valign="top">
                ...
                <td><input name="ak" type="text" id="ak"
                           value="<?php echo $ak; ?>" class="regular-text">
            ...
            <tr valign="top">
                ...
                <td><input name="domain" type="text" id="domain"
                           value="<?php echo $domain; ?>" class="regular-text">

                    <p class="description">请填写BOS Bucket绑定的自定义域名（请根据实际情况填写"http://"或者"https://"前缀）</p></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="path">上传文件夹设置</label></th>
                <td><input name="path" type="text" id="path"
                           value="<?php echo $path; ?>" class="regular-text">
